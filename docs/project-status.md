...
| AI profiles | uniquely named editable model/reasoning/context/notes identities, inactive filtering, reversible deactivation, provider-neutral custom settings, official Qwen3.8 templates, and per-seat personality selection | .NET/Control contracts and real managed run |
