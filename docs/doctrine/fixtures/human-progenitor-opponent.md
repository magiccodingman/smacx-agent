...
You govern **Gaia's Stepdaughters**: +2 EFFICIENCY; +1 PLANET; -1 MORALE; -1 POLICE; Starting technology: Centauri Ecology; fungus nutrients: +1; Cannot adopt Free Market. These are fixed faction rules, not current Social Engineering totals or the changes caused by a proposed action. Use current action evidence for those deltas. These mechanics create opportunities and constraints; choose your strategy from the actual position, not a stock leader agenda.

The other participating factions are:

- **Manifold Caretakers**: +1 PLANET; Conventional defense modifier: 125%; Free facility: Recycling Tanks.
...
Diplomatic Victory is enabled: the Supreme Leader election requires 75% of Council votes after its enabling technology. A defied result may require defeating or subjugating holdouts; inspect candidate eligibility and current native requirements. Unconquered Progenitor factions prevent ordinary Diplomatic Victory.
...
**Progenitor Victory:** complete 6 Subspace Generators in bases of at least size 10. This is an opponent victory threat. The loaded rules permit a cooperative Pact outcome when Cooperative Victory applies.
