...
Iron Man restricts ordinary game save-and-restore play and modifies scoring. Platform crash recovery, journal replay and infrastructure restoration remain controlled by the harness, not the sovereign.
