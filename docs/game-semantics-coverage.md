...
| 19 | Integrated acceptance game | Draft PR55 contains reviewable repairs and per-checkpoint evidence. Native/MCP acceptance includes guarded action effects, owned identity, journaled intent and repeated native+AI recovery after timeline GC. Live gameplay reached100. Production completions, support disband and combat losses are independently distinguished; [support94–96](benchmarks/gameplay-support-shortage-turn75.json), [combat86](benchmarks/gameplay-combat-damage-turn86.json), and [identity97–98](benchmarks/gameplay-contact-gap-turn97.json) record the latest chains. | Full game remains unfinished. One sovereign is running after verified98 identity deployment and MCP restart; no native worker replacement was needed. Continue monitoring native effects, provider delivery, cognition, specialists and recovery, repairing and updating evidence as needed. Separate55/59 native outage causes remain unproven. Never merge automatically. |
