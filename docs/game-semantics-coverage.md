...
| 18 | Evidence-based attribution | [Findings](gameplay-diagnostics-findings.md) distinguish confirmed delivery/semantic/native bugs from affordance weaknesses and missing evidence. Actual erased affordable-hurry answer establishes a harness defect. Later zero-combat prose is paired with a correct delivered count of four combat-capable Scouts; literal inaccuracy is attributable, while the broader strategy remains unjudged. | Earn behavioral attribution from the complete delivered/executed chain; do not promote controlled fixtures into autonomous proof.  Turn75 old-Garrison loss is a native support-shortage outcome before recovery; new-Garrison completion and restore remain proven. Do not attribute it to combat or checkpoint loss.  Turn86 exact next-provider combat receipt includes the outcome qualifier; independent87 owned state and86 destruction event verify survival and enemy destruction, without arrival at the target. Duplicate interval damage reporting is tested and deployed, with one sovereign resumed at90; subsequent damage delivery remains under observation; full-game acceptance remains open ([evidence](benchmarks/gameplay-combat-damage-turn86.json)).  Turn91 attempted stale-plan retirement with cancelled, but plans require abandoned and neither the delivered schema nor error listed statuses. Shared status guidance and rejected-write/canonical-retirement tests pass; deployed at93 and all four status lists are verified in actual request1f606ce86db7433aa03381fb3089efc4; autonomous fresh-guard retirement as completed and exact next-provider receipt now pass at94; status choice is not proof of mechanical objective achievement ([evidence](benchmarks/gameplay-memory-status-turn91.json)).  Turn97 reveals same-square snapshot resurrection after sentinel movement; recorded-shape failure reproduced. Boundary retirement, post-gap damage episodes and one-time private-schema migration pass restart/rollback/owned-identity tests. Full native/MCP suite passes, including repeated checkpoint recovery; quiet-revision migration and publication crash-window tests pass; deployed at98, preserving all11 owned units and foreign observed attributes, with fresh foreign refs stable across an actual MCP restart; one sovereign resumed ([evidence](benchmarks/gameplay-contact-gap-turn97.json)). Turn103 is a confirmed managed capability gap, not sovereign refusal or native crash: the actual native popup has two responses while the managed frame has none. Matched-save comparison verifies the repaired response effects. |
| 19 | Integrated acceptance game | Draft PR55 contains reviewable repairs and per-checkpoint evidence. Native/MCP acceptance includes guarded action effects, owned identity, journaled intent and repeated native+AI recovery after timeline GC. Live gameplay reached104 after verified103 truce repair and recovery. Production completions, support disband and combat losses are independently distinguished; [support94–96](benchmarks/gameplay-support-shortage-turn75.json), [combat86](benchmarks/gameplay-combat-damage-turn86.json), and [identity97–98](benchmarks/gameplay-contact-gap-turn97.json) record the latest chains. | Full game remains unfinished. The sovereign correctly reported WANTTOTRUCE0 with no executable choices at103; native and MCP workers were quarantined. Verified103 recovery now clears the incident and one sovereign resumes. The guarded truce repair passes production-helper and managed-adapter tests; matched-save native accept/reject relationship comparisons pass; broader native/MCP regression and verified103 deployment recovery pass ([evidence](benchmarks/gameplay-truce-offer-turn103.json)). Continue monitoring native effects, provider delivery, cognition, specialists and recovery, repairing and updating evidence as needed. Separate55/59 native outage causes remain unproven. Never merge automatically. |
