...
FILE* debug_log = NULL;
const char* launch_stage = "launcher initialization";
...
void ExitFail() {
    ...
    FILE* error_log = fopen("thinker-launch-error.txt", "w");
    if (error_log) {
        fprintf(error_log, "stage=%s\nerror=%lu\n", launch_stage, code);
        fclose(error_log);
    }
...
int main(int argc, char* argv[]) {
    ...
    */
    launch_stage = "WaitForSingleObject";
