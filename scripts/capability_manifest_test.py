...
def main() -> int:
    ...
    if launches.get("solo_scenario", {}).get("status") != "not_implemented" \
            or launches.get("lan_scenario", {}).get("status") != "not_implemented":
        raise AssertionError("scenario launch must remain honestly fail-closed")
