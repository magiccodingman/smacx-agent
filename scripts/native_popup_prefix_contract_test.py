...
int main() {
 for (auto label : {"SPORESLAUNCHED", "SPOREFOREST", "PRODUPGRADE", "PERIHELION", "PERIHELIONENDS", "SUNSPOTS", "NOMORESPOTS", "MINDCONTROL0", "MINDCONTROL1", "MINDCONTROL2"})
  assert(reviewed_information_popup(label));
 for (auto label : {"SPORESLAUNCHEDX", "SPORE", "SPOREFOREST0", "MONOLITH", "WEASELOUT", "ASKPRODUPGRADE", "MINDCONTROL", "MINDCONTROL3", "MINDCONTROL10"})
  assert(!reviewed_information_popup(label));
